...
| D-07 | Client routing | `react-router-dom` v6 with route guards | Part 5 requires screenshotting "direct access blocked after logout" — impossible without an address bar. |
