...
* **Client routing:** `react-router-dom` v6 is introduced specifically so that "direct access blocked after logout" (AC-15) is demonstrable via the browser address bar, which was not possible under Lab 2's tab-state navigation.
