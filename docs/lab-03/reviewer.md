...
| — | I-4: Auth UI, routing, and Requester regression | `feature/lab3-auth-shell-and-regression` | `lab3-staging` | Pending |
...
*(Appended per PR as review comments arrive and are addressed. Empty until the
first PR above receives a review.)*
